...
class Block(BaseModel):
    ...
    hardness: Optional[confloat(ge=0.0)] = Field(None, description='Hardness of a block')
...
class Effect(BaseModel):
    ...
    type: EffectType = Field(..., description='Whether an effect is positive or negative')
